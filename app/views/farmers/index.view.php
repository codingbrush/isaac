                    ...
                    <table class="table table-bordered table-hover-animation thead-dark">
                        ...
                        <tr>
                            ...
                            <td id="modify" class="d-flex">
                                <a href="/farmers/<?php echo $user->id; ?>" class="btn btn-icon square btn-primary" id="edit"><i class="feather icon-edit none"></i></a>
                                <form action="/farmers/delete/<?php echo $user->id; ?>" method="post" class="pl-1">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="/farmers/create" method="post">
