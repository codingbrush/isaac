...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/public/app-assets/css/pages/error.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    ...
                                    <p class="p-2">
                                        Sorry.. But we just don't know what you are asking for 🤷‍♀️. Please go back and try again. If you are sure it is a problem with us.. Don't hesistate to let us know..😊
                                    </p>                                    
                                    <a class="btn btn-primary btn-lg mt-2" href="javascript:history.go(-1)" title="Return to the previous page"> &laquo; Go Back ></a>
                                </div>
                            </div>
                        </div>
                    </div>
